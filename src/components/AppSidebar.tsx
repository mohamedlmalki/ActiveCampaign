...
import { Upload, UserPlus, Users, Workflow, Plus, Trash2, Pencil, Check, RefreshCw, Mail } from "lucide-react";
...
// No longer needed: import { AddFromFieldDialog } from "./AddFromFieldDialog";
import {
...
const navigationItems = [
  ...
  { title: "Campaign Stats", url: "/campaign-stats", icon: Mail }, // <-- ADD THIS LINE
];
            ...
            <Dialog>
                ...
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            This is the last raw response received from the server when checking credentials.
                        </DialogDescription>
                    </DialogHeader>
  ...
  return (
    <Sidebar className={collapsed ? "w-14" : "w-64"} collapsible="icon">
      <SidebarContent className="bg-card border-r flex flex-col">
        ...
        {/* REMOVED "From Fields" Management */}
        {/* REMOVED Plan Usage */}
        ...
        <div className="mt-auto p-4 text-xs text-muted-foreground">
          {!collapsed && "Built for multi-account ActiveCampaign management"}
        </div>
      </SidebarContent>
    </Sidebar>
  );
